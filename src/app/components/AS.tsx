    ...
    <div className="cv-screen">
      ...
      <PageContent>
        ...
        <div
          ...
          style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '14px 16px', borderRadius: 14, background: C.gradDiag, cursor: 'pointer', marginBottom: 12 }}
        >
          ...
          <svg style={{ marginLeft: 'auto', flexShrink: 0 }} width="16" height="16" fill="none" stroke="rgba(255,255,255,.7)" strokeWidth="2" viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg>
        </div>
      </PageContent>
      <ASNav active="home" />
    </div>
